...
public class MainClass extends Application {
	...
	private static final double MIN_SCENE_HEIGHT = 320;
	...
	public void start(Stage primaryStage) throws Exception {
		...
		Scene loadFileScene = createStyledScene(loadStack, 600, 360);
	...
	private Scene createStyledScene(Parent root, double width, double height) {
		root.setStyle("-fx-background-color: linear-gradient(to bottom right, #eef7ff, #dcecff);"
				+ "-fx-font-family: 'Segoe UI'; -fx-font-size: 15px;");
		styleNodes(root);
		return new Scene(root, Math.max(width, MIN_SCENE_WIDTH), Math.max(height, MIN_SCENE_HEIGHT));
	}

	private void styleNodes(Node node) {
		if (node instanceof Button) {
			...
			if (text.contains("delete")) {
				...
				color = "#2e9d62";
			} else if (text.contains("next") || text.contains("previous")) {
				color = "#596b8c";
			}

			button.setStyle("-fx-background-color: " + color + "; -fx-text-fill: white;"
					+ "-fx-font-weight: bold; -fx-background-radius: 9; -fx-cursor: hand;"
					+ "-fx-padding: 10 22 10 22;");
			button.setMinWidth(130);
			button.setPrefHeight(42);
		} else if (node instanceof TextField) {
			node.setStyle("-fx-background-color: white; -fx-border-color: #8cb7dc;"
					+ "-fx-border-radius: 7; -fx-background-radius: 7; -fx-padding: 9;");
		} else if (node instanceof Label) {
			node.setStyle("-fx-text-fill: #183b56; -fx-font-weight: bold;");
		} else if (node instanceof RadioButton) {
			node.setStyle("-fx-text-fill: #183b56; -fx-padding: 5;");
		} else if (node instanceof MenuBar) {
			node.setStyle("-fx-background-color: #163a5f; -fx-padding: 6;");
		} else if (node instanceof Text) {
			node.setStyle("-fx-fill: #183b56; -fx-font-weight: bold;");
		}
	...
	public void screen(Stage stage) {// display district
		...
		Scene s2 = createStyledScene(vScreen, 600, 360);
		stage.setScene(s2);
	...
	public void disOpertion() {// district operation
		...
		Scene s3 = createStyledScene(root, 700, 520);
	...
	private void insertDistrict() {// insert new district to the list
		...
		Scene s4 = createStyledScene(v, 600, 360);
		stage4.setScene(s4);
	...
	private void updateDistrict() {// update exist district
		...
		Scene s4 = createStyledScene(v, 620, 380);
		stage4.setScene(s4);
	...
	public void locOpertion(String districtName) {// location operation
		...
		Scene s3 = createStyledScene(root, 720, 620);
		thirdStage.setScene(s3);
	...
	private void updateLocation(String districtName) {// update exist location
		...
		v.getChildren().addAll(gridPane, btupdate);
		Scene s4 = createStyledScene(v, 620, 400);
		stage4.setScene(s4);
	...
	private void insertMartyr(String locationName, String districtName) {
		...
		Scene s4 = createStyledScene(bp, 620, 460);
		stage4.setScene(s4);
		stage4.setResizable(false);
	...
	private void martyrOpertaion(String locationName) {// updated and delete martyr from lists
		...
		Scene s4 = createStyledScene(h, 600, 340);
		stage4.setScene(s4);
		stage4.setResizable(false);
	...
	private void deletemartyr(String locationName) {// to delete martyr by name
		...
		Scene s4 = createStyledScene(v, 600, 350);
		stage4.setScene(s4);
		stage4.setResizable(false);
	...
	private void updateMartyr(String locationName) {// update martyr using (name,age,gender,event)
		...
		option1.setOnAction(event -> {// update name
			...
			Scene s4 = createStyledScene(gp, 620, 380);
			stage.setScene(s4);
			stage.setResizable(false);
		...
		Scene s4 = createStyledScene(vbox, 600, 420);
		stage4.setScene(s4);
		stage4.setResizable(false);
	...
	private void sreachBypartOfName(String locationName) {// search martyr by part of name in locationName
		...
		// to clear
		tfn.setText("");
		Scene s4 = createStyledScene(v, 650, 380);
		stage4.setScene(s4);
		stage4.setResizable(false);
